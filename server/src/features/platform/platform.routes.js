...
const { createAgencySchema, listAgenciesQuerySchema, agencyIdParamSchema, setVerifiedSchema, setFeaturedSchema, rejectAgencySchema } = require('./agencies.schema');
...
router.patch('/agencies/:id/approve', validate(agencyIdParamSchema), agenciesController.approve);
router.patch('/agencies/:id/reject', validate(rejectAgencySchema), agenciesController.reject);
