...
## 0:20–1:00 — Customer flow: search & browse

- Show the homepage: point out the real stats row ("these aren't fake numbers
  — that's a live count from the database").
...
## 1:00–2:00 — Inquiry + the lead-scoring "smart feature"
...
> would see everything. And the price estimator is the second smart feature:
> also itemized, not a black box."

## 3:00–3:45 — Code structure & architecture (brief)
...
## 3:45–4:30 — How it was built + deployment
