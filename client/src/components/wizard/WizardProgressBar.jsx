...
const STEPS = ['Basic Details', 'Location', 'Media', 'Amenities', 'Pricing', 'Documents', 'Review']
          ...
          return (
            <div key={label} className="flex flex-1 items-center gap-1 last:flex-none">
              <div className="flex items-center gap-1.5 whitespace-nowrap">
                ...
                <span className={`text-xs ${active ? 'font-semibold text-gray-900 dark:text-white' : 'text-gray-400'}`}>
                  {label}
                </span>
              </div>
